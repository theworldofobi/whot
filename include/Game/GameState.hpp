...
public:
    ...
    /// All players in the game (including eliminated), for stats at game end.
    std::vector<core::Player*> getAllPlayers();
    std::vector<const core::Player*> getAllPlayers() const;
