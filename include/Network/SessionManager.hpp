...
public:
    ...
    // Cleanup
    // Returns the IDs of sessions that were removed so callers can close
    // the corresponding transport connections.
    std::vector<std::string> removeExpiredSessions(int timeoutSeconds);
